...
import {
  require_picomatch
} from "./chunk-V4MKEKP7.js";
import {
  versions_default
} from "./chunk-NEOS45YA.js";
import {
  BUN_LOCKFILE,
  BUN_LOCKFILE_BINARY,
  NPM_LOCKFILE,
...
import {
  glob,
  globSync
} from "./chunk-EGWLH7SG.js";
import {
  slash
} from "./chunk-QHYQ5G5G.js";
import {
  require_dist
...
async function scanAndTransformFiles({
  ...
  const globby = (await import("./globby-FODEQLAP.js")).globby;
...
var transformImportFiles = /* @__PURE__ */ __name(async (files, renamedImports, dryRun) => {
  const errors = [];
  const { default: pLimit } = await import("./p-limit-IJ5D4B4L.js");
